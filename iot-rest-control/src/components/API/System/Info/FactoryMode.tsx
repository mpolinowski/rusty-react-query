...
import { iGetCameraModeApiResponse } from '@/types/iSystem'
...
const getparam=system.factorymode.param.get
const setparam=system.factorymode.param.set
const keymode=system.factorymode.key.mode

const fetchCameraState = async(param: string,): Promise<iGetCameraModeApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetCameraModeApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetCameraModeApiResponse, Error>({
