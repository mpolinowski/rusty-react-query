...
const type=features.ftpaction.type.snap
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['ftpactionsnapattrparams', { getparam }],
...
// const type=features.ftpactionattr.ftpactionsnap
...
//         queryKey: ['ftpactionsnapattrparams', { param }],
