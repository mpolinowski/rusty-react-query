...
import { iGetSdActionAttrApiResponse } from '@/types/iFeatures'
...
const getparam=features.sdactionattr.param.get
const setparam=features.sdactionattr.param.set
const keysnapcount=features.sdactionattr.key.snapcount

const fetchCameraState = async(param: string,): Promise<iGetSdActionAttrApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetSdActionAttrApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetSdActionAttrApiResponse, Error>({
        queryKey: ['sdactionattr', { getparam }],
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=features.sdactionattr

// const fetchData = async(param: string): Promise<iGetSdActionAttrApiResponse> => {
...
//         data,
//         isSuccess
//     }: UseQueryResult<iGetSdActionAttrApiResponse, Error> = useQuery<iGetSdActionAttrApiResponse, Error>({
