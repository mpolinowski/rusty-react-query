...
import { iGetSdAttrApiResponse } from '@/types/iFeatures'
...
const getparam=features.sdattr.param.get
const setparam=features.sdattr.param.set
const keyautodelete=features.sdattr.key.autodelete
const keyenable=features.sdattr.key.enable
const keyduration=features.sdattr.key.duration

const fetchCameraState = async(param: string,): Promise<iGetSdAttrApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetSdAttrApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetSdAttrApiResponse, Error>({
        queryKey: ['sdattr', { getparam }],
            ...
            <>
                <div className="flex gap-2">
                    <Label htmlFor="name" className="text-left min-w-40">
                        ...
                        <Input
                            defaultValue={response?.sd_autodelete}
                            onChange={(e) => setAutodelete(e.target.value)}
                            className="col-span-3"
                        />
                        <Button onClick={
                            () => {updateCameraState(setparam, keyautodelete, autodelete)}
                        }>Submit</Button>
                </div>
                <div className="flex gap-2">
                    <Label htmlFor="name" className="text-left min-w-40">
                        ...
                        <Input
                            defaultValue={response?.sd_rstorage_enable}
                ...
                <div className="flex gap-2">
                    <Label htmlFor="name" className="text-left min-w-40">
                        ...
                        <Input
                            defaultValue={response?.sd_rstorage_duration}
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=features.sdattr

// const fetchData = async(param: string): Promise<iGetSdAttrApiResponse> => {
...
//         data,
//         isSuccess
//     }: UseQueryResult<iGetSdAttrApiResponse, Error> = useQuery<iGetSdAttrApiResponse, Error>({
...
//                         SD Auto-deletion
//                     </Label>
//                     <Input id="name" value={data.sd_autodelete} className="col-span-3" />
//                 </div>
//                 <div className="grid grid-cols-4 items-center gap-4">
//                     <Label htmlFor="name" className="text-left min-w-40">
//                         SD Ring-storage
//                     </Label>
//                     <Input id="name" value={data.sd_rstorage_enable} className="col-span-3" />
//                 </div>
//                 <div className="grid grid-cols-4 items-center gap-4">
//                     <Label htmlFor="name" className="text-left min-w-40">
//                         SD Storage Duration
//                     </Label>
//                     <Input id="name" value={data.sd_rstorage_duration} className="col-span-3" />
//                 </div>
//             </>
//     )
