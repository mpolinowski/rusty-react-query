...
import { iGetMailActionAttrApiResponse } from '@/types/iFeatures'
...
const getparam=features.mailactionattr.param.get
const setparam=features.mailactionattr.param.set
const keysnapcount=features.mailactionattr.key.snapcount

const fetchCameraState = async(param: string,): Promise<iGetMailActionAttrApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetMailActionAttrApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetMailActionAttrApiResponse, Error>({
        queryKey: ['mailactionparams', { getparam }],
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=features.mailactionattr

// const fetchData = async(param: string): Promise<iGetMailActionAttrApiResponse> => {
...
//         data,
//         isSuccess
//     }: UseQueryResult<iGetMailActionAttrApiResponse, Error> = useQuery<iGetMailActionAttrApiResponse, Error>({
//         queryKey: ['mailactionparams', { param }],
