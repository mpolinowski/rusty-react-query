...
import { iGetAudioAlarmAttrApiResponse } from '@/types/iAlarm'
...
const getparam=alarm.audioalarmattr.param.get
const setparam=alarm.audioalarmattr.param.set
const keyenable=alarm.audioalarmattr.key.enable
const keythreshold=alarm.audioalarmattr.key.threshold

const fetchCameraState = async(param: string,): Promise<iGetAudioAlarmAttrApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetAudioAlarmAttrApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetAudioAlarmAttrApiResponse, Error>({
        queryKey: ['audioalarmparams', { getparam }],
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=alarm.audioalarmattr

// const fetchData = async(param: string): Promise<iGetAudioAlarmAttrApiResponse> => {
...
//         data,
//         isSuccess
//     }: UseQueryResult<iGetAudioAlarmAttrApiResponse, Error> = useQuery<iGetAudioAlarmAttrApiResponse, Error>({
//         queryKey: ['audioalarmparams', { param }],
