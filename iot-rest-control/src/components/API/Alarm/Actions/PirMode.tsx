...
import { iGetPirNightModeApiResponse } from '@/types/iAlarm'
...
const getparam=alarm.pirnightmode.param.get
const setparam=alarm.pirnightmode.param.set
const keyenable=alarm.pirnightmode.key.enable
const keyinterval=alarm.pirnightmode.key.interval
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['pirmodeparams', { getparam }],
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=alarm.pirnightmode
