...
const type=alarm.customschedule.type.snap
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['custshedsnapparams', { getparam }],
            ...
            <>
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Sunday (Snap)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Monday (Snap)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Tuesday (Snap)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Wednesday (Snap)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Thurday (Snap)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Friday (Snap)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Saturday (Snap)
                    </Label>
                        <Input
...
// const type=alarm.customschedule.snap
...
//         queryKey: ['custshedsnapparams', { param }],
