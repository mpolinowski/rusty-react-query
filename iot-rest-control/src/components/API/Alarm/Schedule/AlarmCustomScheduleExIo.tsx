...
const type=alarm.customschedule.type.io
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['custshedioparams', { getparam }],
            ...
            <>
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Sunday (IO)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Monday (IO)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Tuesday (IO)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Wednesday (IO)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Thurday (IO)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Friday (IO)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Saturday (IO)
                    </Label>
                        <Input
...
// const type=alarm.customschedule.io
...
//         queryKey: ['custshedioparams', { param }],
