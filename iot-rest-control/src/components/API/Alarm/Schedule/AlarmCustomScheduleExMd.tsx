...
const type=alarm.customschedule.type.md
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['custshedmdparams', { getparam }],
            ...
            <>
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Sunday (MD)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Monday (MD)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Tuesday (MD)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Wednesday (MD)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Thurday (MD)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Friday (MD)
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Custom Schedule Saturday (MD)
                    </Label>
                        <Input
...
// const type=alarm.customschedule.md
...
//         queryKey: ['custshedmdparams', { param }],
