...
const type=alarm.scheduleex.type.ms
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['shedmsparams', { getparam }],
...
// const type=alarm.scheduleex.ms
