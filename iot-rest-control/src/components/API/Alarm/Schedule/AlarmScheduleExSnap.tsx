...
const getparam=alarm.scheduleex.param.get
const setparam=alarm.scheduleex.param.set
const type=alarm.scheduleex.type.snap
const keyweek0=alarm.scheduleex.key.week0
const keyweek1=alarm.scheduleex.key.week1
const keyweek2=alarm.scheduleex.key.week2
const keyweek3=alarm.scheduleex.key.week3
const keyweek4=alarm.scheduleex.key.week4
const keyweek5=alarm.scheduleex.key.week5
const keyweek6=alarm.scheduleex.key.week6
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['shedsnapparams', { getparam }],
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=alarm.scheduleex.param
// const type=alarm.scheduleex.snap
