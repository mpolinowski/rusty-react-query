...
const type=alarm.scheduleex.type.md
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['shedmdparams', { getparam }],
...
// const type=alarm.scheduleex.md
