...
const type=alarm.scheduleex.type.pir
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['shedpirparams', { getparam }],
...
// const type=alarm.scheduleex.pir
