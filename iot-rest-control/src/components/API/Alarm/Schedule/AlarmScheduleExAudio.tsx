...
const type=alarm.scheduleex.type.audio
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['shedaudioparams', { getparam }],
    ...
    return (
            <>
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Audio Schedule Wednesday (Audio)
                    </Label>
                        <Input
...
// const type=alarm.customschedule.audio
...
//         queryKey: ['shedaudioparams', { param }],
