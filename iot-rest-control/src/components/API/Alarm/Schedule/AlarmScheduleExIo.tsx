...
const type=alarm.scheduleex.type.io
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['shedioparams', { getparam }],
...
// const type=alarm.scheduleex.io
