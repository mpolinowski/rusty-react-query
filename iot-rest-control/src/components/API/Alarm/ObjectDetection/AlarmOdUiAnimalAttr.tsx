...
const type=alarm.uiodattr.type.animal
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['oduianimalparams', { getparam }],
...
// const type=alarm.uiodattr.animal
...
//         queryKey: ['oduianimalparams', { param }],
