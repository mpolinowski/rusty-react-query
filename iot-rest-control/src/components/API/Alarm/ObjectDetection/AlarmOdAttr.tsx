...
import { iGetOdAttrApiResponse } from '@/types/iAlarm'
...
const getparam=alarm.odattr.param.get
const setparam=alarm.odattr.param.set
const keyenable=alarm.odattr.key.enable

const fetchCameraState = async(param: string,): Promise<iGetOdAttrApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetOdAttrApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetOdAttrApiResponse, Error>({
        queryKey: ['odparams', { getparam }],
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=alarm.odattr

// const fetchData = async(param: string): Promise<iGetOdAttrApiResponse> => {
...
//         data,
//         isSuccess
//     }: UseQueryResult<iGetOdAttrApiResponse, Error> = useQuery<iGetOdAttrApiResponse, Error>({
//         queryKey: ['odparams', { param }],
