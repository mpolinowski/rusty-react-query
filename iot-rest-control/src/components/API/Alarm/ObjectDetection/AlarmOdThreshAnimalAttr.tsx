...
const type=alarm.odthresh.type.animal
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['odthreshanimalparams', { getparam }],
    ...
    return (
            <>
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Animal Detection Box Minimum Width
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Animal Detection Box Maximum Width
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Animal Detection Box Minimum Height
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Animal Detection Box Maximum Height
                    </Label>
                        <Input
...
// const type=alarm.odthresh.animal
...
//         queryKey: ['odthreshanimalparams', { param }],
