...
const type=alarm.odthresh.type.vehicle
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        queryKey: ['odthreshvehiclparams', { getparam }],
    ...
    return (
            <>
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Vehicle Detection Box Minimum Width
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Vehicle Detection Box Maximum Width
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Vehicle Detection Box Minimum Height
                    </Label>
                        <Input
                ...
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        Vehicle Detection Box Maximum Height
                    </Label>
                        <Input
...
// const type=alarm.odthresh.vehicle
...
//         queryKey: ['odthreshvehiclparams', { param }],
