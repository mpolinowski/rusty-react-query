...
const getparam=multimedia.audioanr.param.get
const setparam=multimedia.audioanr.param.set
const keyAec=multimedia.audioanr.key.aec
const keyAnr=multimedia.audioanr.key.anr
const keyStrength=multimedia.audioanr.key.strength

const fetchCameraState = async(param: string,): Promise<iGetAudioAnrApiResponse> => {
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetAudioAnrApiResponse, Error>({
            ...
            <>
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        ...
                        <Input
                            defaultValue={response?.aec_enable}
                            onChange={(e) => setAec(e.target.value)}
                            className="col-span-3"
                        />
                        <Button onClick={
                            () => {updateCameraState(setparam, keyAec, aec)}
                        }>Submit</Button>
                </div>
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        ...
                        <Input
                            defaultValue={response?.anr_enable}
                            onChange={(e) => setAnr(e.target.value)}
                            className="col-span-3"
                        />
                        <Button onClick={
                            () => {updateCameraState(setparam, keyAnr, anr)}
                        }>Submit</Button>
                </div>
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        ...
                        <Input
                            defaultValue={response?.anr_strength}
                            onChange={(e) => setStrength(e.target.value)}
                            className="col-span-3"
                        />
                        <Button onClick={
                            () => {updateCameraState(setparam, keyStrength, strength)}
                        }>Submit</Button>
                </div>
            </>
    )
