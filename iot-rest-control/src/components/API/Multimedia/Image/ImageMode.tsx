...
import { iGetImageModeApiResponse } from '@/types/iMultimedia'
...
const getparam=multimedia.imagemode.param.get
const setparam=multimedia.imagemode.param.set
const keyMode=multimedia.imagemode.key.mode

const fetchCameraState = async(param: string,): Promise<iGetImageModeApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetImageModeApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetImageModeApiResponse, Error>({
        queryKey: ['imagemodeparams', { getparam }],
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=multimedia.imagemode

// const fetchData = async(param: string): Promise<iGetImageModeApiResponse> => {
...
//         data,
//         isSuccess
//     }: UseQueryResult<iGetImageModeApiResponse, Error> = useQuery<iGetImageModeApiResponse, Error>({
//         queryKey: ['imagemodeparams', { param }],
