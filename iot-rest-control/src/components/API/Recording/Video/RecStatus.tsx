...
import { iGetRecStatusApiResponse } from '@/types/iRecording'
...
const getparam=recording.recordstatus.param.get
const setparam=recording.recordstatus.param.set
const keyrecstatus=recording.recordstatus.key.recstatus
