...
import { iGetIftttApiResponse } from '@/types/iSmarthome'
...
const getparam=smarthome.ifttt.param.get
const setparam=smarthome.ifttt.param.set
const keyenable=smarthome.ifttt.key.enable

const fetchCameraState = async(param: string,): Promise<iGetIftttApiResponse> => {
    ...
    if (response.ok) {
        ...
        const jsonData: iGetIftttApiResponse = JSON.parse(cleanedTextResponse)
...
export default function DataRequest(): React.JSX.Element {
    ...
    const {
        ...
        error,
        data: response
    } = useQuery<iGetIftttApiResponse, Error>({
        queryKey: ['iftttparams', { getparam }],
            ...
            <>
                <div className="flex gap-2 mb-3">
                    <Label htmlFor="name" className="text-left min-w-40">
                        ...
                        <Input
                            defaultValue={response?.ifttt_enable}
...
// const cmd='http://'+login.url+':'+login.port+'/param.cgi?cmd='
// const auth='&user='+login.user+'&pwd='+login.password
// const param=smarthome.ifttt

// const fetchData = async(param: string): Promise<iGetIftttApiResponse> => {
...
//         data,
//         isSuccess
//     }: UseQueryResult<iGetIftttApiResponse, Error> = useQuery<iGetIftttApiResponse, Error>({
//         queryKey: ['iftttparams', { param }],
...
//                     </Label>
//                     <Input id="name" value={data.ifttt_enable} className="col-span-3" />
//                 </div>
//             </div>
//             <SheetFooter>
//                 <SheetClose asChild>
